...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('css/room2.css')}}">
    ...
    <body>
        <div id="image">
            <img src="servicesphotos/servicebg1.jpg"  height="300vh" width="100%">
        </div>
        <div id="title">
            <h1>---------- Deluxe Room ----------</h1>
        </div> 
        <p class="details">Enjoy an amazing stay in our cozy & comfortable deluxe rooms. It comes with single, double & twin bed including 43" Smart LED TV, bathtub & independent high speed Wi-Fi</p>
        ...
        <div class="contain">
            <table border="0" class="tab">
                <tr>
                    <td rowspan="2">
                        <div id="imag"><img src="images/deluxeroom.jpg" height="750vh" width="950vh" alt=""></div>
                    <td id="dates">
        ...
        <div class="container">
            <p>Our Hotel XYZ offers 43 freshly refurnished rooms and suites all with attached bath and shower, air conditioning and heating, International Direct Dial Telephone system, multi Channel color television and mini bar. All rooms have a view over our awards wining gardens or our refreshing swimming pools.</p>
            <table border="1" id="tabsp">
                ...
                <tr>
                    <td class="new"> Deluxe Room </td>
                    <td class="new"> 43 </td>
                    <td class="new"> Rs. 13000 </td>
                    <td class="new"> Rs. 14000 </td>
                </tr>
            </table>
        ...
        <div class="info">
            ...
            <div id="Features" class="tabcontent">
                <ul type="square">
                    <li><font color="#8A191D">Room Size :</font> 287.3 sq. ft.</li>
