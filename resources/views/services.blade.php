    ...
    <body>
        ...
        <div class="services">
            ...
            <div class="row">
                ...
                <div class="wifi">
                    <div class="img">
                        <img src="servicesphotos/wifi available.png" height="80px" width="80px">
                    </div>
                    <h5>Wifi</h5>
                ...
                <div class="meeting-hall">
                    <div class="img">
                        <img src="servicesphotos/meeting hall.png" height="80px" width="80px">
                    </div>
                    <h5>Meeting Hall</h5>
                ...
                <div class="parking">
                    <div class="img">
                        <img src="servicesphotos/free onsite parking.png" height="80px" width="80px">
                    </div>
                    <h5>Free Parking</h5>
                ...
                <div class="doctor">
                    <div class="img">
                        <img src="servicesphotos/doctor on call.png" height="80px" width="80px">
                    </div>
                ...
                <div class="safe-deposit">
                    <div class="img">
                        <img src="servicesphotos/safe deposit.png" height="80px" width="80px">
                    </div>
                    <h5>Safe Deposit</h5>
                ...
                <div class="laundry">
                    <div class="img">
                        <img src="servicesphotos/laundry & drycleaning.png" height="80px" width="80px">
                    </div>
                ...
                <div class="security">
                    <div class="img">
                        <img src="servicesphotos/uniformed security.png" height="80px" width="80px">
                    </div>
                ...
                <div class="smoke">
                    <div class="img">
                        <img src="servicesphotos/smoke detector.png" height="80px" width="80px">
                    </div>
                ...
                <div class="concierge">
                    <div class="img">
                        <img src="servicesphotos/concierge.png" height="80px" width="80px">
                    </div>
                    <h5>Concierge</h5>
