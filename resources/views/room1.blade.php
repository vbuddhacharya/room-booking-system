...
<html lang="en">
    ...
    <body>
        <div id="image">
            <img src="servicesphotos/servicebg.jpg"  height="300vh" width="100%">
        </div>
        <div id="title">
            <h1>---------- Standard Room ----------</h1>
        </div> 
        <p class="details">Enjoy your stay in our inspired standard rooms. It comes with comfortable king size bed or double bed including 43" Smart LED TV, bathtub and independent high speed Wi-Fi.</p>
        ...
        <div class="contain">
            <table border="0" class="tab">
                <tr>
                    <td rowspan="2">
                        <div id="imag"><img src="images/standardroom.jpg" height="750vh" width="950vh" alt=""></div>
                    <td id="dates">
        ...
        <div class="container">
            <p>Our newly renovated standard room is designed so that our guests can feel a touch of modern cultural elements with all the amenities. We offer 44 freshly refurnished rooms with independent fast Wi-Fi, 43” smart LED televisions with HD channels, linens and personal care products and choice of various Nepali organic teas. All rooms have a view over our awards wining gardens or our refreshing swimming pools.</p>
            <table border="1" id="tabsp">
                ...
                <tr>
                    <td class="new"> Standard Room </td>
                    <td class="new"> 45 </td>
                    <td class="new"> Rs. 5000 </td>
                    <td class="new"> Rs. 8000 </td>
                </tr>
            </table>
        ...
        <div class="info">
            ...
            <div id="Features" class="tabcontent">
                <ul type="square">
                    <li><font color="#8A191D">Room Size :</font> 275.2 sq. ft.</li>
